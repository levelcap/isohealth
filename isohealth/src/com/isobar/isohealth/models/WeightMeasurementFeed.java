...
public class WeightMeasurementFeed {
	...
	public WeightMeasurementFeed() {
		super();
	}
	public WeightMeasurementFeed(Integer size, Item[] items, String previous,
			String next) {
		super();
		this.size = size;
		this.items = items;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WeightMeasurementFeed other = (WeightMeasurementFeed) obj;
	...
	public String toString() {
		return "WeightMeasurementFeed [size=" + size + ", items="
